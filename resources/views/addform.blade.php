                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                    <form method="POST" action="{{ route('formSubmit') }}" accept-charset="utf-8" enctype="multipart/form-data">
                        @csrf
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline">
								  <input style="margin-top: 6px;margin-left: 0px;" class="form-check-input @error('status') is-invalid @enderror" type="radio" name="status" id="status" value="0" checked>
								  <label class="form-check-label" for="inlineRadio1">Active</label>
								</div>
								<div class="form-check form-check-inline">
								  <input style="margin-top: 6px;margin-left: 0px;" class="form-check-input @error('status') is-invalid @enderror" type="radio" name="status" id="status1" value="1">
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
								<input type="file" name="profile_pic" id="profile_pic" placeholder="Choose Profile Pic" multiple >
